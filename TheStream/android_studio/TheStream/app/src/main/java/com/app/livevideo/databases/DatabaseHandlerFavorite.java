package com.app.livevideo.databases;
...
public class DatabaseHandlerFavorite extends SQLiteOpenHelper {
    ...
    public void AddtoFavorite(Channel pj) {
        ...
        values.put(KEY_CHANNEL_TYPE, pj.getChannel_type());
    ...
    public List<Channel> getAllData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setChannel_type(cursor.getString(7));
                contact.setVideo_id(cursor.getString(8));
