...
<footer class="footer">
    <div class="container">
        <span class="left span-padding grey-text text-lighten-4"> Copyright © 2018 <a class="grey-text text-lighten-4" href="https://codecanyon.net/user/solodroid/portfolio" target="_blank">Solodroid Developer</a> All rights reserved.</span>

        <span class="right span-padding grey-text text-lighten-4"> Design and Developed by <a class="grey-text text-lighten-4" href="https://www.solodroid.co.id/" target="_blank">Solodroid Developer</a></span>
    </div>
</footer>
<!-- END FOOTER -->
